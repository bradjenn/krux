            ...
            <div className="flex-1 border-l border-border pl-8 pt-2">
              {activeSection === 'appearance' && (
                <div className="space-y-6">
                        ...
                        >
                          <div className="flex gap-1">
                            <span
                              ...
                              style={{ background: preset.ui.accent }}
                            />
                            <span
                              className="w-3 h-3 rounded-full"
                              style={{ background: preset.ui.accent2 }}
                            />
                            <span
                              className="w-3 h-3 rounded-full"
                              style={{ background: preset.ui.bg }}
                            />
                          </div>
                  ...
                  <SettingRow
                    ...
                    description="Show a wallpaper behind the content area"
                  >
                  ...
                  <SettingRow
                    label="Hide titlebar"
                    description="Remove the native window titlebar for a cleaner look"
                  >
                  ...
                  {backgroundImage && (
                    <>
                      <SettingRow
                        ...
                        description="How translucent the terminal overlay is (lower = more wallpaper visible)"
                      >
                        <div className="flex items-center gap-3">
                          <input
                            type="range"
                      ...
                      <SettingRow
                        ...
                        description="Blur the wallpaper image behind the terminal"
                      >
                        <div className="flex items-center gap-3">
                          <input
                            type="range"
              ...
              {activeSection === 'terminal' && (
                <div className="space-y-6">
                  ...
                  <SettingRow
                    label="Scrollback"
                    description="Number of lines kept in scroll history"
                  >
                    <Input
                      type="number"
                      min={1000}
                  ...
                  >
                    <Toggle
                      checked={settings?.use_webgl ?? false}
                      onChange={(v) => {
